...
{ 
    public partial class ProductCategory : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (addButton.Text == "Add")
                {
                    ...
                    {
                        er++;
                        errorProvider.SetError(codeTextBox, "Please Insert  Unique Code");
        ...
        private void addDataGridView_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
            this.addDataGridView.Rows[e.RowIndex].Cells["Sl"].Value = (e.RowIndex + 1).ToString();
        }
    }
}
